...
import { Brain, Eye, EyeOff, UserRound } from "lucide-react"
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8">
        <Card className="mx-auto w-full max-w-md">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold">Login to TaskGenie</CardTitle>
          ...
          <CardContent>
            ...
            <div className="mb-6">
              <Button className="w-full" onClick={handleDirectAccess}>
                Access Dashboard Directly
              </Button>
              <p className="text-xs text-muted-foreground mt-2 text-center">No login required for demo purposes</p>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-muted-foreground">Or login (optional)</span>
              </div>
            </div>
